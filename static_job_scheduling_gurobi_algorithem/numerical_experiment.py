...
Description:
-----------
using the OLB heuristic algorithem to do some experience for the job orchestration problem
-----------
Author: 626
...
from static_job_scheduling_gurobi_algorithem import gurobi_model
...
for exp_num in range(20, 21):
    ...
    # create data
    exp_data = random_careat_data.random_data(exp_tasks_num)
    # create instance
    exp_instance = instances.instance(exp_tasks_num, exp_data.tasks, exp_data.task_denpendency)
    # create gurobi
    ...
    save_path = "C:\\Users\\93561\\Desktop\\code\\Job_Orchestration\\Numerical_experience1.xls"
    book.save(save_path)